...
const checklists: Checklist[] = [
    ...
    { id: '4', title: 'Entering masjid', duas: [{ dua: duas[17], rep: 1 },], },
    { id: '5', title: 'Leaving masjid', duas: [{ dua: duas[18], rep: 1 },], },
    { id: '6', title: 'Before entering washroom', duas: [{ dua: duas[14], rep: 1 },], },
    { id: '7', title: 'After exiting washroom', duas: [{ dua: duas[15], rep: 1 },], },
];
